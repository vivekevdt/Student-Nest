...
export const getListings = async (req, res, next) => {
  try {
    ...
    let studyTable = req.query.studyTable;
    if (studyTable === undefined || studyTable === 'false') {
      studyTable = { $in: [false, true] };
    }
    ...
    let electricityBill = req.query.electricityBill;
    if (electricityBill === undefined || electricityBill === 'false') {
      electricityBill = { $in: [false, true] };
    }

    let type = req.query.type;

    if (type === undefined || type === 'all') {
      type = { $in: ['single', 'sharing'] };
    }
