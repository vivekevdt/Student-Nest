...
export default function MapPicker({ onLocationSelect }) {
  ...
  // 🔸 Removed auto-geolocation — user must manually click “Use My Location”

  // 🔹 Debounced location search (OpenStreetMap Nominatim)
  useEffect(() => {
  ...
  return (
    <div className="space-y-4 w-full mt-4">
      ...
      {/* Optional: Display coordinates + address if selected */}
      {selectedPosition && (
        <div className="grid sm:grid-cols-2 gap-4 text-sm text-gray-700">
          ...
          <div className="sm:col-span-2">
            ...
            <p className="mt-1 bg-gray-50 p-2 border rounded">
              {address || "Click on the map or use the search bar"}
            </p>
          </div>
        </div>
      )}
